            ...
            <div class="col-sm">
                <div class="form-group">
                    <label>Nama Lengkap:</label>
                        <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Lengkap" value="<?php echo $this->session->userdata('id_calon'); ?>">
                </div>
        <div class="row">
            <div class="col-sm">
                <div class="form-group">
                    <label>Nomor Identitas (NISN):</label>
                        <input type="text" name="nisn" class="form-control" placeholder="Masukan Nomor NISN" value="<?php echo $this->session->userdata('nisn'); ?>">
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                    <label>Jenis Kelamin:</label>
                    <input type="text" name="jenis_kelamin" class="form-control" placeholder="Masukan No Hp" value="<?php echo $this->session->userdata('jenis_kelamin'); ?>">
                </div>
            </div>
        </div>
                </div>
            ...
            <div class="col-sm">
                <div class="form-group">
                    <label>Tempat Lahir:</label>
                        <input type="text" name="tempat_lahir" class="form-control" placeholder="Masukan Tempat Lahir" value="<?php echo $this->session->userdata('tempat_lahir'); ?>">
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                    <label>Tanggal Lahir:</label>
                        <input type="date" name="tanggal_lahir" class="form-control" value="<?php echo $this->session->userdata('tanggal_lahir'); ?>">
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                    <label>No Hp:</label>
                        <input type="text" name="no_hp" class="form-control" placeholder="Masukan No Hp" value="<?php echo $this->session->userdata('no_hp'); ?>">    
                   </div>
                </div>
                <div class="col-sm">
                <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm">
                <div class="form-group">
                    <label>Asal Sekolah:</label>
                        <input type="text" name="asal sekolah" class="form-control" placeholder="Masukan asal sekolah" value="<?php echo $this->session->userdata('asal_sekolah'); ?>">
                </div>
            </div>
        ...
        <div class="col-sm">
            <div class="form-group">
                ...
                <input type="text" name="pilihan_id_pilihan" class="form-control" placeholder="Masukan No Hp" value="<?php echo $this->session->userdata('pilihan'); ?>">
            </div>
        </div>
